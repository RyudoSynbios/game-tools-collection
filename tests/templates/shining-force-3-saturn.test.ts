...
test.describe(game, () => {
  ...
  const tests: Test[] = [
    ...
    ["should load a filled BKR save (Patched)"            ,               "filled.bkr", ["r|scenario1", 't|["Slot 1"]'         , "s|1$1", "s|2$2", "s|1$3" , "c|0x0000d109", "i|PASS"    , "w|QASS"    , "c|0x0000d10a"]],
    ...
    ["should load a filled padded BKR save (Patched)"     ,           "filled-bkr.bin", ["r|scenario1", 't|["Slot 1"]'         , "s|1$1", "s|2$2", "s|1$3" , "c|0x0000d108", "i|PASS"    , "w|QASS"    , "c|0x0000d109"]],
    ...
    ["should load a BKR save (Scenario 1) (Japan) (Rev A)", "scenario1-japan-reva.bkr", [               't|["Slot 1"]'         , "s|1$1", "s|2$2", "s|1$3" , "c|0x0000f341", "i|こﾞうかく", "w|さ\"うかく", "c|0x0000f342"]],
