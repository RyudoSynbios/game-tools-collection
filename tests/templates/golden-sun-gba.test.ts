...
describe(game, () => {
  ...
  test.each([
    ...
    ["should load a standard save (Japan)"            ,         "japan.sav", ["r|japan"  , 't|["Slot 3"]'         , "s|3", "c|0x7259$1", "c|0x722a$2", "i|こ\"うかく$1", "i|42$2", "i|42$3", "w|43$2", "i|43$3", "c|0x70d3$1", "c|0x7167$2"]],
    ...
    ["should load a GameShark save (Japan)"           ,         "japan.sps", ["r|japan"  , 't|["Slot 1"]'         , "s|1", "c|0x7241$1", "c|0x7222$2", "i|こ\"うかく$1", "i|29$2", "i|29$3", "w|30$2", "i|30$3", "c|0x70bb$1", "c|0x715f$2"]],
