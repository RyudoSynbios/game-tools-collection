...
test.describe(game, () => {
  ...
  const tests: Test[] = [
    ...
    ["should load a filled Collection save"           ,  "filled.bin", ["r|japan" , 't|["General","Slot 3"]', "i|Japanese", "s|4", "i|PASS"]],
    ["should load a Collection save (Europe)"         ,  "europe.bin", [            't|["General","Slot 1"]', "i|English" , "s|2", "i|PASS"]],
    ["should load a Collection save (USA)"            ,     "usa.bin", [            't|["General","Slot 1"]', "i|English" , "s|2", "i|PASS"]],
    ["should load a Collection save (Japan)"          ,   "japan.bin", [            't|["General","Slot 3"]', "i|Japanese", "s|4", "i|PASS"]],
  ];
