...
test.describe(game, () => {
  ...
  const tests: Test[] = [
    ...
    ["should load a PSV save (Europe, Australia)"     , "europeaustralia.psv", [            't|["Slot 9"]'           , "s|9$1" , "c|0xc763", "i|21", "w|22", "c|0x497a", "s|3$3", "i|PASS"]],
    ["should load a PSV save (USA)"                   ,             "usa.psv", [            't|["Slot 15"]'          , "s|15$1", "c|0x46a0", "i|15", "w|16", "c|0xaa26", "s|3$3", "i|PASS"]],
    ["should load a PSV save (Japan, Asia)"           ,       "japanasia.psv", [            't|["Slot 7"]'           , "s|7$1" , "c|0x1e06", "i|12", "w|13", "c|0x557e", "s|3$3", "i|PASS"]],
    ["should load a PSV save (France)"                ,          "france.psv", [            't|["Slot 1"]'           , "s|1$1" , "c|0x46a0", "i|19", "w|20", "c|0x122e", "s|3$3", "i|PASS"]],
    ["should load a PSV save (Germany)"               ,         "germany.psv", [            't|["Slot 11"]'          , "s|11$1", "c|0x7935", "i|19", "w|20", "c|0x6fc8", "s|3$3", "i|PASS"]],
    ["should load a PSV save (Italy)"                 ,           "italy.psv", [            't|["Slot 3"]'           , "s|3$1" , "c|0x7bd8", "i|19", "w|20", "c|0xc0bf", "s|3$3", "i|PASS"]],
    ["should load a PSV save (Spain)"                 ,           "spain.psv", [            't|["Slot 5"]'           , "s|5$1" , "c|0x3c97", "i|19", "w|20", "c|0x2e64", "s|3$3", "i|PASS"]],
