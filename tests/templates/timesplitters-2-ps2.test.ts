...
test.describe(game, () => {
  ...
  const tests: Test[] = [
    ...
    ["should load a PSV save (Europe)"            ,        "europe.psv", [           "c|0x7e676459", 't|["PASS"]'       , "s|1$1", "i|PASS$1", "i|00$2", "w|01$2", "c|0xc0173267"]],
    ["should load a PSV save (USA)"               ,           "usa.psv", [           "c|0xb9782e98", 't|["FAIL","PASS"]', "s|2$1", "i|PASS$1", "i|00$2", "w|01$2", "c|0x48e26540"]],
    ["should load a PSV save (Japan)"             ,         "japan.psv", [           "c|0x1b32fa0d", 't|["PASS"]'       , "s|1$1", "i|PASS$1", "i|00$2", "w|01$2", "c|0xa542ac33"]],
    ["should load a PSU save (Europe)"            ,        "europe.psu", [           "c|0x7e676459", 't|["PASS"]'       , "s|1$1", "i|PASS$1", "i|00$2", "w|01$2", "c|0xc0173267"]],
    ["should load a PSU save (USA)"               ,           "usa.psu", [           "c|0xb9782e98", 't|["FAIL","PASS"]', "s|2$1", "i|PASS$1", "i|00$2", "w|01$2", "c|0x48e26540"]],
    ["should load a PSU save (Japan)"             ,         "japan.psu", [           "c|0x1b32fa0d", 't|["PASS"]'       , "s|1$1", "i|PASS$1", "i|00$2", "w|01$2", "c|0xa542ac33"]],
  ];
