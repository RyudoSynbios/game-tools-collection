...
test.describe(game, () => {
  ...
  const tests: Test[] = [
    ...
    ["should load a standard save (USA)"          ,      "usa.mcr", [            "s|2$1", "s|2$2", "s|8$3", "c|0x2839", "i|PAS", "w|QAS", "c|0x283a"]],
    ["should load a standard save (Japan)"        ,    "japan.mcr", [            "s|2$1", "s|2$2", "s|2$3", "c|0x2327", "i|PAS", "w|QAS", "c|0x2328"]],
    ...
    ["should load a VMP save (USA)"               ,      "usa.vmp", [            "s|2$1", "s|2$2", "s|8$3", "c|0x2839", "i|PAS", "w|QAS", "c|0x283a"]],
    ["should load a VMP save (Japan)"             ,    "japan.vmp", [            "s|2$1", "s|2$2", "s|2$3", "c|0x2327", "i|PAS", "w|QAS", "c|0x2328"]],
    ["should load a DexDrive save (Europe)"       ,   "europe.gme", [            "s|2$1", "s|2$2", "s|3$3", "c|0x29b8", "i|PAS", "w|QAS", "c|0x29b9"]],
    ["should load a DexDrive save (USA)"          ,      "usa.gme", [            "s|2$1", "s|2$2", "s|8$3", "c|0x2839", "i|PAS", "w|QAS", "c|0x283a"]],
    ["should load a DexDrive save (Japan)"        ,    "japan.gme", [            "s|2$1", "s|2$2", "s|2$3", "c|0x2327", "i|PAS", "w|QAS", "c|0x2328"]],
  ];
