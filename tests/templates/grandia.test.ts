...
test.describe(game, () => {
  ...
  const tests: Test[] = [
    ...
    ["should load a PSV save (USA)"                ,             "usa.psv", [            't|["Slot 2"]'                  , "s|2", "i|07$1", "i|50$2"]],
    ["should load a PSV save (Japan)"              ,           "japan.psv", [            't|["Slot 5"]'                  , "s|5", "i|08$1", "i|00$2"]],
    ["should load a PSV save (France)"             ,          "france.psv", [            't|["Slot 2"]'                  , "s|2", "i|08$1", "i|21$2"]],
    ["should load a PSV save (Germany)"            ,         "germany.psv", [            't|["Slot 4"]'                  , "s|4", "i|08$1", "i|31$2"]],
    ...
    ["should load a PC save"                       , "BISLPSP02124GRA-S00", [            't|["Slot 1"]'                  , "s|1", "i|10$1", "i|56$2"]],
  ];
