...
test.describe(game, () => {
  ...
  const tests: Test[] = [
    ...
    ["should load a PSV save (USA)"                 ,            "usa.psv", [         't|["Slot 3"]'         , "s|3" , "c|0x4f5602000054780e", "i|PASS", "w|QASS", "c|0x4f5602000054780e"]],
    ["should load a PSV save (Japan)"               ,          "japan.psv", [         't|["Slot 12"]'        , "s|12", "c|0x4f3c040600f84e8e", "i|PASS", "w|QASS", "c|0x4f3c040600f84e8e"]],
    ["should load a PSV save (Japan) (Rev 1)"       ,     "japan-rev1.psv", [         't|["Slot 15"]'        , "s|15", "c|0x4f3c04000014622e", "i|PASS", "w|QASS", "c|0x4f3c04000014622e"]],
