...
const template: GameJson = {
  validator: {
    regions: {
      europe: {
        $and: [{ 0x34: [0x44, 0x41] }, { 0x1dc: [0x48, 0x49] }],
      },
      usa_japan: {
        $and: [{ 0x34: [0x44, 0x41] }, { 0x1dc: [0x48, 0x49] }],
      },
                  ...
                  items: [
                    ...
                    },
                    {
                      ...
                      flags: [
                        ...
                        { offset: 0x9, bit: 4, label: "Star Door to Clock Room open once", hidden: true, separator: true },
              ...
              items: [
                {
                  ...
                  flags: [
                    ...
                    { offset: 0xc, bit: 5, label: "Behind Chain Chomp's Gate" },
                    { offset: 0xc, bit: 6, label: "100 Coins", separator: true },
                  ],
                },
                {
                  type: "section",
              ...
              items: [
                {
                  ...
                  flags: [
                    ...
                    { offset: 0xd, bit: 5, label: "Blast Away the Wall" },
              ...
              items: [
                {
                  ...
                  flags: [
                    ...
                    { offset: 0xe, bit: 5, label: "Through the Jet Stream" },
                    { offset: 0xe, bit: 6, label: "100 Coins", separator: true },
                  ],
                },
                {
                  type: "section",
              ...
              items: [
                {
                  ...
                  flags: [
                    ...
                    { offset: 0xf, bit: 5, label: "Wall Kicks will Work" },
              ...
              items: [
                {
                  ...
                  flags: [
                    ...
                    { offset: 0x10, bit: 5, label: "Eye to Eye in the Secret Room" },
              ...
              items: [
                {
                  ...
                  flags: [
                    ...
                    { offset: 0x11, bit: 5, label: "Watch for the Rolling Rocks" },
              ...
              items: [
                {
                  ...
                  flags: [
                    ...
                    { offset: 0x12, bit: 5, label: "Elevator Tour in the Volcano" },
              ...
              items: [
                {
                  ...
                  flags: [
                    ...
                    { offset: 0x13, bit: 5, label: "Pyramid Puzzle" },
              ...
              items: [
                {
                  ...
                  flags: [
                    ...
                    { offset: 0x14, bit: 5, label: "Collect the Caps" },
              ...
              items: [
                {
                  ...
                  flags: [
                    ...
                    { offset: 0x15, bit: 5, label: "Into the Igloo" },
              ...
              items: [
                {
                  ...
                  flags: [
                    ...
                    { offset: 0x16, bit: 5, label: "Quick Race through Downtown" },
              ...
              items: [
                {
                  ...
                  flags: [
                    ...
                    { offset: 0x17, bit: 5, label: "Blast to the Lonely Mushroom" },
              ...
              items: [
                {
                  ...
                  flags: [
                    ...
                    { offset: 0x18, bit: 5, label: "Make Wiggler Squirm" },
              ...
              items: [
                {
                  ...
                  flags: [
                    ...
                    { offset: 0x19, bit: 5, label: "Stop Time for Red Coins" },
              ...
              items: [
                {
                  ...
                  flags: [
                    ...
                    { offset: 0x1a, bit: 5, label: "Somewhere Over the Rainbow" },
