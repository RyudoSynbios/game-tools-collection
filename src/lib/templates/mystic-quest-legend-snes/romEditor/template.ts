          ...
          items: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  type: "bitflags",
                  flags: [
                    { offset: 0x21, bit: 0, name: "Silence" },
                    { offset: 0x21, bit: 1, name: "Blind" },
                    { offset: 0x21, bit: 2, name: "Poison" },
                    { offset: 0x21, bit: 7, name: "Fatal" },
                  ],
                },
                {
                  type: "section",
                  ...
                  items: [
                    {
                      ...
                      type: "bitflags",
                      flags: [
                        { offset: 0x32, bit: 7, name: "Steel Sword" },
                        { offset: 0x32, bit: 6, name: "Knight Sword" },
                        { offset: 0x32, bit: 5, name: "Excalibur" },
                        { offset: 0x32, bit: 4, name: "Axe" },
                        { offset: 0x32, bit: 3, name: "Battle Axe" },
                        { offset: 0x32, bit: 2, name: "Giant's Axe" },
                        { offset: 0x32, bit: 1, name: "Cat Claw" },
                        { offset: 0x32, bit: 0, name: "Charm Claw" },
                        { offset: 0x33, bit: 7, name: "Dragon Claw" },
                        { offset: 0x33, bit: 6, name: "Bomb" },
                        { offset: 0x33, bit: 5, name: "Jumbo Bomb" },
                        { offset: 0x33, bit: 4, name: "Mega Grenade" },
                      ],
                    },
                    {
                      name: "Armors",
                      type: "bitflags",
                      flags: [
                        { offset: 0x35, bit: 7, name: "Steel Helm" },
                        { offset: 0x35, bit: 6, name: "Moon Helm" },
                        { offset: 0x35, bit: 5, name: "Apollo Helm" },
                        { offset: 0x35, bit: 4, name: "Steel Armor" },
                        { offset: 0x35, bit: 3, name: "Noble Armor" },
                        { offset: 0x35, bit: 2, name: "Gaia's Armor" },
                        { offset: 0x36, bit: 5, name: "Steel Shield" },
                        { offset: 0x36, bit: 4, name: "Venus Shield" },
                        { offset: 0x36, bit: 3, name: "Aegis Shield" },
                        { offset: 0x36, bit: 1, name: "Charm" },
                        { offset: 0x36, bit: 0, name: "Magic Ring" },
                        { offset: 0x37, bit: 7, name: "Cupid Locket" },
                      ],
                    },
                    {
                      name: "Spells",
                      type: "bitflags",
                      flags: [
                        { offset: 0x38, bit: 7, name: "Exit" },
                        { offset: 0x38, bit: 6, name: "Cure" },
                        { offset: 0x38, bit: 5, name: "Heal" },
                        { offset: 0x38, bit: 4, name: "Life" },
                        { offset: 0x38, bit: 3, name: "Quack" },
                        { offset: 0x38, bit: 2, name: "Blizzard" },
                        { offset: 0x38, bit: 1, name: "Fire" },
                        { offset: 0x38, bit: 0, name: "Aero" },
                        { offset: 0x39, bit: 7, name: "Thunder" },
                        { offset: 0x39, bit: 6, name: "White" },
                        { offset: 0x39, bit: 5, name: "Meteor" },
                        { offset: 0x39, bit: 4, name: "Flare" },
                      ],
                    },
                  ],
                },
                      ...
                      items: [
                        {
                          ...
                          type: "bitflags",
                          flags: [
                            { offset: 0x3, bit: 0, name: "???", hidden: true },
                            { offset: 0x3, bit: 1, name: "???", hidden: true },
                            { offset: 0x3, bit: 4, name: "???", hidden: true },
                            {
                              offset: 0x3,
                              bit: 5,
                              name: "Animate Flying Monsters",
                            },
                            { offset: 0x3, bit: 6, name: "Can't Escape" },
                            { offset: 0x3, bit: 7, name: "???", hidden: true },
                          ],
                        },
                        {
                          name: "Battle Music",
