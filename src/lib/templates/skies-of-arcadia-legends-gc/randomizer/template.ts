        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              type: "bitflags",
              flags: [
                { offset: 0xa4, bit: 0, label: "All magic unlocked" }, // prettier-ignore
                { offset: 0xa4, bit: 1, label: "All Special moves unlocked", separator: true }, // prettier-ignore
                { offset: 0xa4, bit: 2, label: "Magic costs 0 Spirit" }, // prettier-ignore
                { offset: 0xa4, bit: 3, label: "Special moves costs 0 Spirit" }, // prettier-ignore
              ],
            },
          ],
        },
