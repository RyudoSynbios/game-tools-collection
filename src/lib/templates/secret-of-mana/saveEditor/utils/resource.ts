...
const armorList = [
  { index: 0x01, type: 0x0, name: "Bandanna" },
  { index: 0x02, type: 0x0, name: "Hair Ribbon" },
  { index: 0x03, type: 0x0, name: "Rabite Cap" },
  { index: 0x04, type: 0x0, name: "Head Gear" },
  { index: 0x05, type: 0x0, name: "Quill Cap" },
  { index: 0x06, type: 0x0, name: "Steel Cap" },
  { index: 0x07, type: 0x0, name: "Golden Tiara" },
  { index: 0x08, type: 0x0, name: "Raccoon Cap" },
  { index: 0x09, type: 0x0, name: "Quilted Hood" },
  { index: 0x0a, type: 0x0, name: "Tiger Cap" },
  { index: 0x0b, type: 0x0, name: "Circlet" },
  { index: 0x0c, type: 0x0, name: "Ruby Armet" },
  { index: 0x0d, type: 0x0, name: "Unicorn Helm" },
  { index: 0x0e, type: 0x0, name: "Dragon Helm" },
  { index: 0x0f, type: 0x0, name: "Duck Helm" },
