...
export const progressionList = [
  { index: 0x0, min: 0x00, max: 0x02, name: "Zone 1: Leaf Forest" },
  { index: 0x1, min: 0x03, max: 0x06, name: "Zone 2: Hot Crater" },
  { index: 0x2, min: 0x07, max: 0x0a, name: "Zone 3: Music Plant" },
  { index: 0x3, min: 0x0b, max: 0x0e, name: "Zone 4: Ice Paradise" },
  { index: 0x4, min: 0x0f, max: 0x12, name: "Zone 5: Sky Canyon" },
