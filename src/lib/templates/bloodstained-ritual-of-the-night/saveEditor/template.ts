          ...
          items: [
            {
              ...
              items: [
                ...
                {
                  name: "Techniques",
                  items: techniqueList.map((technique) => ({
                    name: technique.name,
                    type: "section",
                    flex: true,
                    items: [
                      {
                        name: "Use Count",
                        offset: 0x0,
                        jsonPath: `GameRecordParsed.PCInfo.m_ArtsUseNum[${technique.index}]`,
                        type: "variable",
                        dataType: "uint32",
                      },
                      {
                        name: "Experience",
                        offset: 0x0,
                        jsonPath: `GameRecordParsed.PCInfo.m_ArtsExperience[${technique.index}]`,
                        type: "variable",
                        dataType: "uint32",
                        max: technique.experience,
                      },
                    ],
                  })),
                },
