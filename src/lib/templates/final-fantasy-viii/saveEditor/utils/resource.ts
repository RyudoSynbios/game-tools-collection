...
export const gfAbilityList = [
  { index: 0x01, type: 0x0, ap:  50, name: "HP-J" },
  { index: 0x02, type: 0x0, ap:  50, name: "Str-J" },
  { index: 0x03, type: 0x0, ap:  50, name: "Vit-J" },
  { index: 0x04, type: 0x0, ap:  50, name: "Mag-J" },
  { index: 0x05, type: 0x0, ap:  50, name: "Spr-J" },
  { index: 0x06, type: 0x0, ap: 120, name: "Spd-J" },
  { index: 0x07, type: 0x0, ap: 200, name: "Eva-J" },
  { index: 0x08, type: 0x0, ap: 120, name: "Hit-J" },
  { index: 0x09, type: 0x0, ap: 200, name: "Luck-J" },
  { index: 0x0a, type: 0x0, ap: 160, name: "Elem-Atk-J" },
  { index: 0x0b, type: 0x0, ap: 160, name: "ST-Atk-J" },
  { index: 0x0c, type: 0x0, ap: 100, name: "Elem-Def-J" },
  { index: 0x0d, type: 0x0, ap: 100, name: "ST-Def-J" },
  { index: 0x0e, type: 0x0, ap: 130, name: "Elem-Defx2" },
  { index: 0x0f, type: 0x0, ap: 180, name: "Elem-Defx4" },
  { index: 0x10, type: 0x0, ap: 130, name: "ST-Def-Jx2" },
  { index: 0x11, type: 0x0, ap: 180, name: "ST-Def-Jx4" },
  { index: 0x12, type: 0x0, ap: 150, name: "Abilityx3" },
  { index: 0x13, type: 0x0, ap: 200, name: "Abilityx4" },
  { index: 0x14, type: 0x1, ap:   1, name: "Magic" },
  { index: 0x15, type: 0x1, ap:   1, name: "GF" },
  { index: 0x16, type: 0x1, ap:   1, name: "Draw" },
  { index: 0x17, type: 0x1, ap:   1, name: "Item" },
  { index: 0x18, type: 0x1, ap: 250, name: "Empty" },
  { index: 0x19, type: 0x1, ap:  40, name: "Card" },
  { index: 0x1a, type: 0x1, ap:  60, name: "Doom" },
  { index: 0x1b, type: 0x1, ap:  60, name: "Mad Rush" },
  { index: 0x1c, type: 0x1, ap: 100, name: "Treatment" },
  { index: 0x1d, type: 0x1, ap: 100, name: "Defend" },
  { index: 0x1e, type: 0x1, ap: 100, name: "Darkside" },
  { index: 0x1f, type: 0x1, ap: 200, name: "Recover" },
  { index: 0x20, type: 0x1, ap:  80, name: "Absorb" },
  { index: 0x21, type: 0x1, ap: 200, name: "Revive" },
  { index: 0x22, type: 0x1, ap: 100, name: "LV Down" },
  { index: 0x23, type: 0x1, ap: 100, name: "LV Up" },
  { index: 0x24, type: 0x1, ap: 100, name: "Kamikaze" },
  { index: 0x25, type: 0x1, ap: 100, name: "Devour" },
  { index: 0x26, type: 0x1, ap: 100, name: "MiniMog" },
  { index: 0x27, type: 0x2, ap:  60, name: "HP+20%" },
  { index: 0x28, type: 0x2, ap: 120, name: "HP+40%" },
  { index: 0x29, type: 0x2, ap: 240, name: "HP+80%" },
  { index: 0x2a, type: 0x2, ap:  60, name: "Str+20%" },
  { index: 0x2b, type: 0x2, ap: 120, name: "Str+40%" },
  { index: 0x2c, type: 0x2, ap: 240, name: "Str+60%" },
  { index: 0x2d, type: 0x2, ap:  60, name: "Vit+20%" },
  { index: 0x2e, type: 0x2, ap: 120, name: "Vit+40%" },
  { index: 0x2f, type: 0x2, ap: 240, name: "Vit+60%" },
  { index: 0x30, type: 0x2, ap:  60, name: "Mag+20%" },
  { index: 0x31, type: 0x2, ap: 120, name: "Mag+40%" },
  { index: 0x32, type: 0x2, ap: 240, name: "Mag+60%" },
  { index: 0x33, type: 0x2, ap:  60, name: "Spr+20%" },
  { index: 0x34, type: 0x2, ap: 120, name: "Spr+40%" },
  { index: 0x35, type: 0x2, ap: 240, name: "Spr+60%" },
  { index: 0x36, type: 0x2, ap: 150, name: "Spd+20%" },
  { index: 0x37, type: 0x2, ap: 200, name: "Spd+40%" },
  { index: 0x38, type: 0x2, ap: 150, name: "Eva+30%" },
  { index: 0x39, type: 0x2, ap: 200, name: "Luck+50%" },
  { index: 0x3a, type: 0x2, ap: 200, name: "Mug" },
  { index: 0x3b, type: 0x2, ap: 200, name: "Med Data" },
  { index: 0x3c, type: 0x2, ap: 200, name: "Counter" },
  { index: 0x3d, type: 0x2, ap: 250, name: "Return Damage" },
  { index: 0x3e, type: 0x2, ap: 100, name: "Cover" },
  { index: 0x3f, type: 0x2, ap: 160, name: "Initiative" },
  { index: 0x40, type: 0x2, ap: 200, name: "Move-HP Up" },
  { index: 0x41, type: 0x2, ap: 100, name: "HP Bonus" },
  { index: 0x42, type: 0x2, ap: 100, name: "Str Bonus" },
  { index: 0x43, type: 0x2, ap: 100, name: "Vit Bonus" },
  { index: 0x44, type: 0x2, ap: 100, name: "Mag Bonus" },
  { index: 0x45, type: 0x2, ap: 100, name: "Spr Bonus" },
  { index: 0x46, type: 0x2, ap: 250, name: "Auto-Protect" },
  { index: 0x47, type: 0x2, ap: 250, name: "Auto-Shell" },
  { index: 0x48, type: 0x2, ap: 250, name: "Auto-Reflect" },
  { index: 0x49, type: 0x2, ap: 250, name: "Auto-Haste" },
  { index: 0x4a, type: 0x2, ap: 150, name: "Auto-Potion" },
  { index: 0x4b, type: 0x2, ap: 250, name: "Expendx2-1" },
  { index: 0x4c, type: 0x2, ap: 250, name: "Expendx3-1" },
  { index: 0x4d, type: 0x2, ap:   1, name: "Ribbon" },
  { index: 0x4e, type: 0x3, ap: 200, name: "Alert" },
  { index: 0x4f, type: 0x3, ap:  40, name: "Move-Find" },
  { index: 0x50, type: 0x3, ap:  30, name: "Enc-Half" },
  { index: 0x51, type: 0x3, ap: 100, name: "Enc-None" },
  { index: 0x52, type: 0x3, ap: 250, name: "Rare Item" },
  { index: 0x53, type: 0x4, ap:  40, name: "SumMag+10%" },
  { index: 0x54, type: 0x4, ap:  70, name: "SumMag+20%" },
  { index: 0x55, type: 0x4, ap: 140, name: "SumMag+30%" },
  { index: 0x56, type: 0x4, ap: 200, name: "SumMag+40%" },
  { index: 0x57, type: 0x4, ap:  40, name: "GFHP+10%" },
  { index: 0x58, type: 0x4, ap:  70, name: "GFHP+20%" },
  { index: 0x59, type: 0x4, ap: 140, name: "GFHP+30%" },
  { index: 0x5a, type: 0x4, ap: 200, name: "GFHP+40%" },
  { index: 0x5b, type: 0x4, ap:  10, name: "Boost" },
  { index: 0x5c, type: 0x5, ap: 150, name: "Haggle" },
  { index: 0x5d, type: 0x5, ap: 150, name: "Sell-High" },
  { index: 0x5e, type: 0x5, ap: 150, name: "Familiar" },
  { index: 0x5f, type: 0x5, ap: 200, name: "Call Shop" },
  { index: 0x60, type: 0x5, ap: 150, name: "Junk Shop" },
  { index: 0x61, type: 0x5, ap:  30, name: "T Mag-RF" },
  { index: 0x62, type: 0x5, ap:  30, name: "I Mag-RF" },
  { index: 0x63, type: 0x5, ap:  30, name: "F Mag-RF" },
  { index: 0x64, type: 0x5, ap:  30, name: "L Mag-RF" },
  { index: 0x65, type: 0x5, ap:  30, name: "Time Mag-RF" },
  { index: 0x66, type: 0x5, ap:  30, name: "ST Mag-RF" },
  { index: 0x67, type: 0x5, ap:  30, name: "Supt Mag-RF" },
  { index: 0x68, type: 0x5, ap:  30, name: "Forbid Mag-RF" },
  { index: 0x69, type: 0x5, ap:  30, name: "Recov Med-RF" },
  { index: 0x6a, type: 0x5, ap:  30, name: "ST Med-RF" },
  { index: 0x6b, type: 0x5, ap:  30, name: "Ammo-RF" },
  { index: 0x6c, type: 0x5, ap:  30, name: "Tool-RF" },
  { index: 0x6d, type: 0x5, ap: 200, name: "Forbid Med-RF" },
  { index: 0x6e, type: 0x5, ap:  30, name: "GFRecov Med-RF" },
  { index: 0x6f, type: 0x5, ap:  30, name: "GFAbl Med-RF" },
  { index: 0x70, type: 0x5, ap:  60, name: "Mid Mag-RF" },
  { index: 0x71, type: 0x5, ap:  60, name: "High Mag-RF" },
  { index: 0x72, type: 0x5, ap: 120, name: "Med LV Up" },
  { index: 0x73, type: 0x5, ap:  80, name: "Card Mod" },
];
...
export const commonCards = [
  { index: 0x00, name: "Geezard" },
  { index: 0x01, name: "Funguar" },
  { index: 0x02, name: "Bite Bug" },
  { index: 0x03, name: "Red Bat" },
  { index: 0x04, name: "Blobra" },
  { index: 0x05, name: "Gayla" },
  { index: 0x06, name: "Gesper" },
  { index: 0x07, name: "Fastitocalon-F" },
  { index: 0x08, name: "Blood Soul" },
  { index: 0x09, name: "Caterchipillar" },
  { index: 0x0a, name: "Cockatrice" },
  { index: 0x0b, name: "Grat" },
  { index: 0x0c, name: "Buel" },
  { index: 0x0d, name: "Mesmerize" },
  { index: 0x0e, name: "Glacial Eye" },
  { index: 0x0f, name: "Belhelmel" },
...
export const uniqueCards = [
  { index: 0x00, name: "Chubby Chocobo" },
  { index: 0x01, name: "Angelo" },
  { index: 0x02, name: "Gilgamesh" },
  { index: 0x03, name: "MiniMog" },
  { index: 0x04, name: "Chicobo" },
  { index: 0x05, name: "Quezacotl" },
  { index: 0x06, name: "Shiva" },
  { index: 0x07, name: "Ifrit" },
  { index: 0x08, name: "Siren" },
  { index: 0x09, name: "Sacred" },
  { index: 0x0a, name: "Minotaur" },
  { index: 0x0b, name: "Carbuncle" },
  { index: 0x0c, name: "Diablos" },
  { index: 0x0d, name: "Leviathan" },
  { index: 0x0e, name: "Odin" },
  { index: 0x0f, name: "Pandemona" },
