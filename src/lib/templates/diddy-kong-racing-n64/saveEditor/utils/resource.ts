...
export const records = [
  { index: 0x4, ttIndex: 0x14, name: "Ancient Lake", vehicules: ["Car", "Hover", "Plane"] },
  { index: 0x0, ttIndex: 0x15, name: "Fossil Canyon", vehicules: ["Car", "Hover", "Plane"] },
  { index: 0x22, ttIndex: 0x16, name: "Jungle Falls", vehicules: ["Car", "Hover", "Plane"] },
  { index: 0x9, ttIndex: 0x17, name: "Hot Top Volcano", vehicules: ["Hover", "Plane"] },
  { index: 0xb, ttIndex: 0x8, name: "Whale Bay", vehicules: ["Hover"] },
  { index: 0x3, ttIndex: 0x9, name: "Pirate Lagoon", vehicules: ["Hover"] },
  { index: 0xe, ttIndex: 0xa, name: "Crescent Island", vehicules: ["Car", "Hover"] },
  { index: 0x25, ttIndex: 0xb, name: "Treasure Caves", vehicules: ["Car", "Hover", "Plane"] },
  { index: 0x10, ttIndex: 0xc, name: "Everfrost Peak", vehicules: ["Car", "Hover", "Plane"] },
  { index: 0x7, ttIndex: 0xd, name: "Walrus Cove", vehicules: ["Car", "Hover"] },
  { index: 0xc, ttIndex: 0xe, name: "Snowball Valley", vehicules: ["Car", "Hover"] },
  { index: 0x1f, ttIndex: 0xf, name: "Frosty Village", vehicules: ["Car", "Hover", "Plane"] },
  { index: 0x1b, ttIndex: 0x0, name: "Boulder Canyon", vehicules: ["Hover"] },
  { index: 0x19, ttIndex: 0x1, name: "Greenwood Village", vehicules: ["Car", "Hover"] },
  { index: 0x1c, ttIndex: 0x2, name: "Windmill Plains", vehicules: ["Car", "Hover", "Plane"] },
  { index: 0x28, ttIndex: 0x3, name: "Haunted Woods", vehicules: ["Car", "Hover"] },
  { index: 0x16, ttIndex: 0x4, name: "Spacedust Alley", vehicules: ["Car", "Hover", "Plane"] },
  { index: 0x2a, ttIndex: 0x5, name: "Darkmoon Caverns", vehicules: ["Car", "Hover"] },
  { index: 0x2c, ttIndex: 0x6, name: "Star City", vehicules: ["Car", "Hover", "Plane"] },
  { index: 0x13, ttIndex: 0x7, name: "Spaceport Alpha", vehicules: ["Car", "Hover", "Plane"] },
];
