                      ...
                      items: [
                        {
                          ...
                          type: "bitflags",
                          flags: [
                            { offset: 0x3e8, bit: 0, label: "001 Bat" },
                            { offset: 0x3e8, bit: 1, label: "002 Zombie" },
                            { offset: 0x3e8, bit: 2, label: "003 Skeleton" },
                            { offset: 0x3e8, bit: 3, label: "004 Ghost" },
                            { offset: 0x3e8, bit: 4, label: "005 Banshee" },
                            { offset: 0x3e8, bit: 5, label: "006 Bone Scimitar" },
                            { offset: 0x3e8, bit: 6, label: "007 Sea Stinger" },
                            { offset: 0x3e8, bit: 7, label: "008 Nominon", separator: true },
                            { offset: 0x3e9, bit: 0, label: "009 Axe Knight" },
                            { offset: 0x3e9, bit: 1, label: "010 Une" },
                            { offset: 0x3e9, bit: 2, label: "011 Merman" },
                            { offset: 0x3e9, bit: 3, label: "012 Necromancer" },
                            { offset: 0x3e9, bit: 4, label: "013 Bone Archer" },
                            { offset: 0x3e9, bit: 5, label: "014 Spear Guard" },
                            { offset: 0x3e9, bit: 6, label: "015 Invisible Man" },
                            { offset: 0x3e9, bit: 7, label: "016 Gelso", separator: true },
                            { offset: 0x3ea, bit: 0, label: "017 Needles" },
                            { offset: 0x3ea, bit: 1, label: "018 Demon" },
                            { offset: 0x3ea, bit: 2, label: "019 Fishhead" },
                            { offset: 0x3ea, bit: 3, label: "020 Dark Octopus" },
                            { offset: 0x3ea, bit: 4, label: "021 Killer Fish" },
                            { offset: 0x3ea, bit: 5, label: "022 Forneus" },
                            { offset: 0x3ea, bit: 6, label: "023 The Creature" },
                            { offset: 0x3ea, bit: 7, label: "024 Black Crow", separator: true },
                            { offset: 0x3eb, bit: 0, label: "025 Skull Spider" },
                            { offset: 0x3eb, bit: 1, label: "026 Scarecrow" },
                            { offset: 0x3eb, bit: 2, label: "027 Sea Demon" },
                            { offset: 0x3eb, bit: 3, label: "028 Winged Guard" },
                            { offset: 0x3eb, bit: 4, label: "029 Nightmare" },
                            { offset: 0x3eb, bit: 5, label: "030 Rock Knight" },
                            { offset: 0x3eb, bit: 6, label: "031 Fire Demon" },
                            { offset: 0x3eb, bit: 7, label: "032 Bitterfly", separator: true },
                            { offset: 0x3ec, bit: 0, label: "033 Specter" },
                            { offset: 0x3ec, bit: 1, label: "034 Grave Digger" },
                            { offset: 0x3ec, bit: 2, label: "035 Werebat" },
                            { offset: 0x3ec, bit: 3, label: "036 Black Fomor" },
                            { offset: 0x3ec, bit: 4, label: "037 Enkidu" },
                            { offset: 0x3ec, bit: 5, label: "038 Bone Pillar" },
                            { offset: 0x3ec, bit: 6, label: "039 Skeleton Frisky" },
                            { offset: 0x3ec, bit: 7, label: "040 Skeleton Hero", separator: true },
                            { offset: 0x3ed, bit: 0, label: "041 Dullahan" },
                            { offset: 0x3ed, bit: 1, label: "042 Skeleton Rex" },
                            { offset: 0x3ed, bit: 2, label: "043 White Dragon" },
                            { offset: 0x3ed, bit: 3, label: "044 Saint Elmo" },
                            { offset: 0x3ed, bit: 4, label: "045 Lorelai" },
                            { offset: 0x3ed, bit: 5, label: "046 Edimmu" },
                            { offset: 0x3ed, bit: 6, label: "047 Decarabia" },
                            { offset: 0x3ed, bit: 7, label: "048 Merman", separator: true },
                            { offset: 0x3ee, bit: 0, label: "049 Ladycat" },
                            { offset: 0x3ee, bit: 1, label: "050 Ectoplasm" },
                            { offset: 0x3ee, bit: 2, label: "051 Curse Diva" },
                            { offset: 0x3ee, bit: 3, label: "052 Miss Murder" },
                            { offset: 0x3ee, bit: 4, label: "053 Automaton ZX26" },
                            { offset: 0x3ee, bit: 5, label: "054 Skeleton Beast" },
                            { offset: 0x3ee, bit: 6, label: "055 Balloon" },
                            { offset: 0x3ee, bit: 7, label: "056 Arachne", separator: true },
                            { offset: 0x3ef, bit: 0, label: "057 Lizardman" },
                            { offset: 0x3ef, bit: 1, label: "058 Armored Beast" },
                            { offset: 0x3ef, bit: 2, label: "059 Yeti" },
                            { offset: 0x3ef, bit: 3, label: "060 Thunder Demon" },
                            { offset: 0x3ef, bit: 4, label: "061 Owl" },
                            { offset: 0x3ef, bit: 5, label: "062 Werewolf" },
                            { offset: 0x3ef, bit: 6, label: "063 Altair" },
                            { offset: 0x3ef, bit: 7, label: "064 Mandragora", separator: true },
                            { offset: 0x3f0, bit: 0, label: "065 Jersey Devil" },
                            { offset: 0x3f0, bit: 1, label: "066 Owl Knight" },
                            { offset: 0x3f0, bit: 2, label: "067 Chosen Une" },
                            { offset: 0x3f0, bit: 3, label: "068 Stone Rose" },
                            { offset: 0x3f0, bit: 4, label: "069 Mad Butcher" },
                            { offset: 0x3f0, bit: 5, label: "070 White Formor" },
                            { offset: 0x3f0, bit: 6, label: "071 Evil Force" },
                            { offset: 0x3f0, bit: 7, label: "072 Flea Man", separator: true },
                            { offset: 0x3f1, bit: 0, label: "073 Ghoul" },
                            { offset: 0x3f1, bit: 1, label: "074 Peeping Eye" },
                            { offset: 0x3f1, bit: 2, label: "075 Gargoyle" },
                            { offset: 0x3f1, bit: 3, label: "076 Blood Skeleton" },
                            { offset: 0x3f1, bit: 4, label: "077 Black Panther" },
                            { offset: 0x3f1, bit: 5, label: "078 Mimic" },
                            { offset: 0x3f1, bit: 6, label: "079 Draculina" },
                            { offset: 0x3f1, bit: 7, label: "080 Tin Man", separator: true },
                            { offset: 0x3f2, bit: 0, label: "081 Polkir" },
                            { offset: 0x3f2, bit: 1, label: "082 Nova Skeleton" },
                            { offset: 0x3f2, bit: 2, label: "083 Gashida" },
                            { offset: 0x3f2, bit: 3, label: "084 Devil" },
                            { offset: 0x3f2, bit: 4, label: "085 Gurkha Master" },
                            { offset: 0x3f2, bit: 5, label: "086 Red Smasher" },
                            { offset: 0x3f2, bit: 6, label: "087 Cave Troll" },
                            { offset: 0x3f2, bit: 7, label: "088 Blade Master", separator: true },
                            { offset: 0x3f3, bit: 0, label: "089 Lilith" },
                            { offset: 0x3f3, bit: 1, label: "090 Lizardman Blade" },
                            { offset: 0x3f3, bit: 2, label: "091 Hammer Shaker" },
                            { offset: 0x3f3, bit: 3, label: "092 Rebuild" },
                            { offset: 0x3f3, bit: 4, label: "093 Imp" },
                            { offset: 0x3f3, bit: 5, label: "094 Bugbear" },
                            { offset: 0x3f3, bit: 6, label: "095 Spectral Sword" },
                            { offset: 0x3f3, bit: 7, label: "096 Automaton ZX27", separator: true },
                            { offset: 0x3f4, bit: 0, label: "097 Medusa Head" },
                            { offset: 0x3f4, bit: 1, label: "098 Gorgon Head" },
                            { offset: 0x3f4, bit: 2, label: "099 Mad Snatcher" },
                            { offset: 0x3f4, bit: 3, label: "100 Great Knight" },
                            { offset: 0x3f4, bit: 4, label: "101 King Skeleton" },
                            { offset: 0x3f4, bit: 5, label: "102 Winged Skeleton" },
                            { offset: 0x3f4, bit: 6, label: "103 Final Knight" },
                            { offset: 0x3f4, bit: 7, label: "104 Jiang Shi", separator: true },
                            { offset: 0x3f5, bit: 0, label: "105 Demon Lord" },
                            { offset: 0x3f5, bit: 1, label: "106 Double Hammer" },
                            { offset: 0x3f5, bit: 2, label: "107 Weapon Master" },
                            { offset: 0x3f5, bit: 3, label: "108 Giant Skeleton" },
                            { offset: 0x3f5, bit: 4, label: "109 Arthroverta" },
                            { offset: 0x3f5, bit: 5, label: "110 Brachyura" },
                            { offset: 0x3f5, bit: 6, label: "111 Maneater" },
                            { offset: 0x3f5, bit: 7, label: "112 Rusalka", separator: true },
                            { offset: 0x3f6, bit: 0, label: "113 Goliath" },
                            { offset: 0x3f6, bit: 1, label: "114 Gravedorcus" },
                            { offset: 0x3f6, bit: 2, label: "115 Albus" },
                            { offset: 0x3f6, bit: 3, label: "116 Barlowe" },
                            { offset: 0x3f6, bit: 4, label: "117 Wallman" },
                            { offset: 0x3f6, bit: 5, label: "118 Blackmore" },
                            { offset: 0x3f6, bit: 6, label: "119 Eligor" },
                            { offset: 0x3f6, bit: 7, label: "120 Death", separator: true },
                            { offset: 0x3f7, bit: 0, label: "121 Dracula" },
                          ],
                        },
                        {
                          name: "Drops",
                          type: "bitflags",
                          flags: [
                            { offset: 0x3f8, bit: 0, label: "001 Bat", disabled: true },
                            { offset: 0x3f8, bit: 1, label: "002 Zombie" },
                            { offset: 0x3f8, bit: 2, label: "003 Skeleton", disabled: true },
                            { offset: 0x3f8, bit: 3, label: "004 Ghost", disabled: true },
                            { offset: 0x3f8, bit: 4, label: "005 Banshee", disabled: true },
                            { offset: 0x3f8, bit: 5, label: "006 Bone Scimitar", disabled: true },
                            { offset: 0x3f8, bit: 6, label: "007 Sea Stinger", disabled: true },
                            { offset: 0x3f8, bit: 7, label: "008 Nominon", separator: true, disabled: true },
                            { offset: 0x3f9, bit: 0, label: "009 Axe Knight" },
                            { offset: 0x3f9, bit: 1, label: "010 Une", disabled: true },
                            { offset: 0x3f9, bit: 2, label: "011 Merman" },
                            { offset: 0x3f9, bit: 3, label: "012 Necromancer", disabled: true },
                            { offset: 0x3f9, bit: 4, label: "013 Bone Archer", disabled: true },
                            { offset: 0x3f9, bit: 5, label: "014 Spear Guard" },
                            { offset: 0x3f9, bit: 6, label: "015 Invisible Man", disabled: true },
                            { offset: 0x3f9, bit: 7, label: "016 Gelso", separator: true, disabled: true },
                            { offset: 0x3fa, bit: 0, label: "017 Needles" },
                            { offset: 0x3fa, bit: 1, label: "018 Demon", disabled: true },
                            { offset: 0x3fa, bit: 2, label: "019 Fishhead" },
                            { offset: 0x3fa, bit: 3, label: "020 Dark Octopus" },
                            { offset: 0x3fa, bit: 4, label: "021 Killer Fish", disabled: true },
                            { offset: 0x3fa, bit: 5, label: "022 Forneus" },
                            { offset: 0x3fa, bit: 6, label: "023 The Creature", disabled: true },
                            { offset: 0x3fa, bit: 7, label: "024 Black Crow", separator: true, disabled: true },
                            { offset: 0x3fb, bit: 0, label: "025 Skull Spider" },
                            { offset: 0x3fb, bit: 1, label: "026 Scarecrow", disabled: true },
                            { offset: 0x3fb, bit: 2, label: "027 Sea Demon", disabled: true },
                            { offset: 0x3fb, bit: 3, label: "028 Winged Guard", disabled: true },
                            { offset: 0x3fb, bit: 4, label: "029 Nightmare" },
                            { offset: 0x3fb, bit: 5, label: "030 Rock Knight" },
                            { offset: 0x3fb, bit: 6, label: "031 Fire Demon" },
                            { offset: 0x3fb, bit: 7, label: "032 Bitterfly", separator: true, disabled: true },
                            { offset: 0x3fc, bit: 0, label: "033 Specter", disabled: true },
                            { offset: 0x3fc, bit: 1, label: "034 Grave Digger" },
                            { offset: 0x3fc, bit: 2, label: "035 Werebat", disabled: true },
                            { offset: 0x3fc, bit: 3, label: "036 Black Fomor" },
                            { offset: 0x3fc, bit: 4, label: "037 Enkidu", disabled: true },
                            { offset: 0x3fc, bit: 5, label: "038 Bone Pillar", disabled: true },
                            { offset: 0x3fc, bit: 6, label: "039 Skeleton Frisky", disabled: true },
                            { offset: 0x3fc, bit: 7, label: "040 Skeleton Hero", separator: true, disabled: true },
                            { offset: 0x3fd, bit: 0, label: "041 Dullahan", disabled: true },
                            { offset: 0x3fd, bit: 1, label: "042 Skeleton Rex", disabled: true },
                            { offset: 0x3fd, bit: 2, label: "043 White Dragon", disabled: true },
                            { offset: 0x3fd, bit: 3, label: "044 Saint Elmo", disabled: true },
                            { offset: 0x3fd, bit: 4, label: "045 Lorelai", disabled: true },
                            { offset: 0x3fd, bit: 5, label: "046 Edimmu", disabled: true },
                            { offset: 0x3fd, bit: 6, label: "047 Decarabia", disabled: true },
                            { offset: 0x3fd, bit: 7, label: "048 Merman", separator: true },
                            { offset: 0x3fe, bit: 0, label: "049 Ladycat" },
                            { offset: 0x3fe, bit: 1, label: "050 Ectoplasm" },
                            { offset: 0x3fe, bit: 2, label: "051 Curse Diva" },
                            { offset: 0x3fe, bit: 3, label: "052 Miss Murder", disabled: true },
                            { offset: 0x3fe, bit: 4, label: "053 Automaton ZX26" },
                            { offset: 0x3fe, bit: 5, label: "054 Skeleton Beast", disabled: true },
                            { offset: 0x3fe, bit: 6, label: "055 Balloon", disabled: true },
                            { offset: 0x3fe, bit: 7, label: "056 Arachne", separator: true },
                            { offset: 0x3ff, bit: 0, label: "057 Lizardman" },
                            { offset: 0x3ff, bit: 1, label: "058 Armored Beast" },
                            { offset: 0x3ff, bit: 2, label: "059 Yeti", disabled: true },
                            { offset: 0x3ff, bit: 3, label: "060 Thunder Demon", disabled: true },
                            { offset: 0x3ff, bit: 4, label: "061 Owl", disabled: true },
                            { offset: 0x3ff, bit: 5, label: "062 Werewolf", disabled: true },
                            { offset: 0x3ff, bit: 6, label: "063 Altair" },
                            { offset: 0x3ff, bit: 7, label: "064 Mandragora", separator: true, disabled: true },
                            { offset: 0x400, bit: 0, label: "065 Jersey Devil", disabled: true },
                            { offset: 0x400, bit: 1, label: "066 Owl Knight" },
                            { offset: 0x400, bit: 2, label: "067 Chosen Une", disabled: true },
                            { offset: 0x400, bit: 3, label: "068 Stone Rose", disabled: true },
                            { offset: 0x400, bit: 4, label: "069 Mad Butcher", disabled: true },
                            { offset: 0x400, bit: 5, label: "070 White Formor", disabled: true },
                            { offset: 0x400, bit: 6, label: "071 Evil Force", disabled: true },
                            { offset: 0x400, bit: 7, label: "072 Flea Man", separator: true, disabled: true },
                            { offset: 0x401, bit: 0, label: "073 Ghoul" },
                            { offset: 0x401, bit: 1, label: "074 Peeping Eye", disabled: true },
                            { offset: 0x401, bit: 2, label: "075 Gargoyle", disabled: true },
                            { offset: 0x401, bit: 3, label: "076 Blood Skeleton", disabled: true },
                            { offset: 0x401, bit: 4, label: "077 Black Panther", disabled: true },
                            { offset: 0x401, bit: 5, label: "078 Mimic", disabled: true },
                            { offset: 0x401, bit: 6, label: "079 Draculina" },
                            { offset: 0x401, bit: 7, label: "080 Tin Man", separator: true },
                            { offset: 0x402, bit: 0, label: "081 Polkir", disabled: true },
                            { offset: 0x402, bit: 1, label: "082 Nova Skeleton", disabled: true },
                            { offset: 0x402, bit: 2, label: "083 Gashida", disabled: true },
                            { offset: 0x402, bit: 3, label: "084 Devil", disabled: true },
                            { offset: 0x402, bit: 4, label: "085 Gurkha Master" },
                            { offset: 0x402, bit: 5, label: "086 Red Smasher" },
                            { offset: 0x402, bit: 6, label: "087 Cave Troll", disabled: true },
                            { offset: 0x402, bit: 7, label: "088 Blade Master", separator: true, disabled: true },
                            { offset: 0x403, bit: 0, label: "089 Lilith" },
                            { offset: 0x403, bit: 1, label: "090 Lizardman Blade", disabled: true },
                            { offset: 0x403, bit: 2, label: "091 Hammer Shaker" },
                            { offset: 0x403, bit: 3, label: "092 Rebuild", disabled: true },
                            { offset: 0x403, bit: 4, label: "093 Imp", disabled: true },
                            { offset: 0x403, bit: 5, label: "094 Bugbear", disabled: true },
                            { offset: 0x403, bit: 6, label: "095 Spectral Sword", disabled: true },
                            { offset: 0x403, bit: 7, label: "096 Automaton ZX27", separator: true },
                            { offset: 0x404, bit: 0, label: "097 Medusa Head", disabled: true },
                            { offset: 0x404, bit: 1, label: "098 Gorgon Head", disabled: true },
                            { offset: 0x404, bit: 2, label: "099 Mad Snatcher", disabled: true },
                            { offset: 0x404, bit: 3, label: "100 Great Knight", disabled: true },
                            { offset: 0x404, bit: 4, label: "101 King Skeleton" },
                            { offset: 0x404, bit: 5, label: "102 Winged Skeleton", disabled: true },
                            { offset: 0x404, bit: 6, label: "103 Final Knight" },
                            { offset: 0x404, bit: 7, label: "104 Jiang Shi", separator: true, disabled: true },
                            { offset: 0x405, bit: 0, label: "105 Demon Lord", disabled: true },
                            { offset: 0x405, bit: 1, label: "106 Double Hammer" },
                            { offset: 0x405, bit: 2, label: "107 Weapon Master" },
                            { offset: 0x405, bit: 3, label: "108 Giant Skeleton", disabled: true },
                            { offset: 0x405, bit: 4, label: "109 Arthroverta", disabled: true },
                            { offset: 0x405, bit: 5, label: "110 Brachyura", disabled: true },
                            { offset: 0x405, bit: 6, label: "111 Maneater", disabled: true },
                            { offset: 0x405, bit: 7, label: "112 Rusalka", separator: true, disabled: true },
                            { offset: 0x406, bit: 0, label: "113 Goliath", disabled: true },
                            { offset: 0x406, bit: 1, label: "114 Gravedorcus", disabled: true },
                            { offset: 0x406, bit: 2, label: "115 Albus", disabled: true },
                            { offset: 0x406, bit: 3, label: "116 Barlowe", disabled: true },
                            { offset: 0x406, bit: 4, label: "117 Wallman", disabled: true },
                            { offset: 0x406, bit: 5, label: "118 Blackmore", disabled: true },
                            { offset: 0x406, bit: 6, label: "119 Eligor", disabled: true },
                            { offset: 0x406, bit: 7, label: "120 Death", separator: true, disabled: true },
                            { offset: 0x407, bit: 0, label: "121 Dracula", disabled: true },
                          ],
                        },
                        {
                          name: "Rare Drops",
                          type: "bitflags",
                          flags: [
                            { offset: 0x408, bit: 0, label: "001 Bat", disabled: true },
                            { offset: 0x408, bit: 1, label: "002 Zombie", disabled: true },
                            { offset: 0x408, bit: 2, label: "003 Skeleton", disabled: true },
                            { offset: 0x408, bit: 3, label: "004 Ghost", disabled: true },
                            { offset: 0x408, bit: 4, label: "005 Banshee", disabled: true },
                            { offset: 0x408, bit: 5, label: "006 Bone Scimitar", disabled: true },
                            { offset: 0x408, bit: 6, label: "007 Sea Stinger", disabled: true },
                            { offset: 0x408, bit: 7, label: "008 Nominon", separator: true, disabled: true },
                            { offset: 0x409, bit: 0, label: "009 Axe Knight", disabled: true },
                            { offset: 0x409, bit: 1, label: "010 Une", disabled: true },
                            { offset: 0x409, bit: 2, label: "011 Merman" },
                            { offset: 0x409, bit: 3, label: "012 Necromancer", disabled: true },
                            { offset: 0x409, bit: 4, label: "013 Bone Archer", disabled: true },
                            { offset: 0x409, bit: 5, label: "014 Spear Guard", disabled: true },
                            { offset: 0x409, bit: 6, label: "015 Invisible Man", disabled: true },
                            { offset: 0x409, bit: 7, label: "016 Gelso", separator: true, disabled: true },
                            { offset: 0x40a, bit: 0, label: "017 Needles", disabled: true },
                            { offset: 0x40a, bit: 1, label: "018 Demon", disabled: true },
                            { offset: 0x40a, bit: 2, label: "019 Fishhead", disabled: true },
                            { offset: 0x40a, bit: 3, label: "020 Dark Octopus", disabled: true },
                            { offset: 0x40a, bit: 4, label: "021 Killer Fish" },
                            { offset: 0x40a, bit: 5, label: "022 Forneus", disabled: true },
                            { offset: 0x40a, bit: 6, label: "023 The Creature", disabled: true },
                            { offset: 0x40a, bit: 7, label: "024 Black Crow", separator: true, disabled: true },
                            { offset: 0x40b, bit: 0, label: "025 Skull Spider", disabled: true },
                            { offset: 0x40b, bit: 1, label: "026 Scarecrow", disabled: true },
                            { offset: 0x40b, bit: 2, label: "027 Sea Demon", disabled: true },
                            { offset: 0x40b, bit: 3, label: "028 Winged Guard", disabled: true },
                            { offset: 0x40b, bit: 4, label: "029 Nightmare", disabled: true },
                            { offset: 0x40b, bit: 5, label: "030 Rock Knight", disabled: true },
                            { offset: 0x40b, bit: 6, label: "031 Fire Demon" },
                            { offset: 0x40b, bit: 7, label: "032 Bitterfly", separator: true, disabled: true },
                            { offset: 0x40c, bit: 0, label: "033 Specter", disabled: true },
                            { offset: 0x40c, bit: 1, label: "034 Grave Digger", disabled: true },
                            { offset: 0x40c, bit: 2, label: "035 Werebat", disabled: true },
                            { offset: 0x40c, bit: 3, label: "036 Black Fomor", disabled: true },
                            { offset: 0x40c, bit: 4, label: "037 Enkidu", disabled: true },
                            { offset: 0x40c, bit: 5, label: "038 Bone Pillar", disabled: true },
                            { offset: 0x40c, bit: 6, label: "039 Skeleton Frisky", disabled: true },
                            { offset: 0x40c, bit: 7, label: "040 Skeleton Hero", separator: true, disabled: true },
                            { offset: 0x40d, bit: 0, label: "041 Dullahan", disabled: true },
                            { offset: 0x40d, bit: 1, label: "042 Skeleton Rex", disabled: true },
                            { offset: 0x40d, bit: 2, label: "043 White Dragon", disabled: true },
                            { offset: 0x40d, bit: 3, label: "044 Saint Elmo", disabled: true },
                            { offset: 0x40d, bit: 4, label: "045 Lorelai" },
                            { offset: 0x40d, bit: 5, label: "046 Edimmu", disabled: true },
                            { offset: 0x40d, bit: 6, label: "047 Decarabia", disabled: true },
                            { offset: 0x40d, bit: 7, label: "048 Merman", separator: true, disabled: true },
                            { offset: 0x40e, bit: 0, label: "049 Ladycat" },
                            { offset: 0x40e, bit: 1, label: "050 Ectoplasm", disabled: true },
                            { offset: 0x40e, bit: 2, label: "051 Curse Diva", disabled: true },
                            { offset: 0x40e, bit: 3, label: "052 Miss Murder", disabled: true },
                            { offset: 0x40e, bit: 4, label: "053 Automaton ZX26", disabled: true },
                            { offset: 0x40e, bit: 5, label: "054 Skeleton Beast" },
                            { offset: 0x40e, bit: 6, label: "055 Balloon", disabled: true },
                            { offset: 0x40e, bit: 7, label: "056 Arachne", separator: true, disabled: true },
                            { offset: 0x40f, bit: 0, label: "057 Lizardman", disabled: true },
                            { offset: 0x40f, bit: 1, label: "058 Armored Beast", disabled: true },
                            { offset: 0x40f, bit: 2, label: "059 Yeti", disabled: true },
                            { offset: 0x40f, bit: 3, label: "060 Thunder Demon", disabled: true },
                            { offset: 0x40f, bit: 4, label: "061 Owl", disabled: true },
                            { offset: 0x40f, bit: 5, label: "062 Werewolf", disabled: true },
                            { offset: 0x40f, bit: 6, label: "063 Altair", disabled: true },
                            { offset: 0x40f, bit: 7, label: "064 Mandragora", separator: true },
                            { offset: 0x410, bit: 0, label: "065 Jersey Devil", disabled: true },
                            { offset: 0x410, bit: 1, label: "066 Owl Knight", disabled: true },
                            { offset: 0x410, bit: 2, label: "067 Chosen Une", disabled: true },
                            { offset: 0x410, bit: 3, label: "068 Stone Rose", disabled: true },
                            { offset: 0x410, bit: 4, label: "069 Mad Butcher", disabled: true },
                            { offset: 0x410, bit: 5, label: "070 White Formor" },
                            { offset: 0x410, bit: 6, label: "071 Evil Force", disabled: true },
                            { offset: 0x410, bit: 7, label: "072 Flea Man", separator: true },
                            { offset: 0x411, bit: 0, label: "073 Ghoul", disabled: true },
                            { offset: 0x411, bit: 1, label: "074 Peeping Eye" },
                            { offset: 0x411, bit: 2, label: "075 Gargoyle", disabled: true },
                            { offset: 0x411, bit: 3, label: "076 Blood Skeleton", disabled: true },
                            { offset: 0x411, bit: 4, label: "077 Black Panther", disabled: true },
                            { offset: 0x411, bit: 5, label: "078 Mimic", disabled: true },
                            { offset: 0x411, bit: 6, label: "079 Draculina" },
                            { offset: 0x411, bit: 7, label: "080 Tin Man", separator: true },
                            { offset: 0x412, bit: 0, label: "081 Polkir", disabled: true },
                            { offset: 0x412, bit: 1, label: "082 Nova Skeleton", disabled: true },
                            { offset: 0x412, bit: 2, label: "083 Gashida", disabled: true },
                            { offset: 0x412, bit: 3, label: "084 Devil", disabled: true },
                            { offset: 0x412, bit: 4, label: "085 Gurkha Master", disabled: true },
                            { offset: 0x412, bit: 5, label: "086 Red Smasher", disabled: true },
                            { offset: 0x412, bit: 6, label: "087 Cave Troll", disabled: true },
                            { offset: 0x412, bit: 7, label: "088 Blade Master", separator: true, disabled: true },
                            { offset: 0x413, bit: 0, label: "089 Lilith", disabled: true },
                            { offset: 0x413, bit: 1, label: "090 Lizardman Blade", disabled: true },
                            { offset: 0x413, bit: 2, label: "091 Hammer Shaker", disabled: true },
                            { offset: 0x413, bit: 3, label: "092 Rebuild", disabled: true },
                            { offset: 0x413, bit: 4, label: "093 Imp", disabled: true },
                            { offset: 0x413, bit: 5, label: "094 Bugbear", disabled: true },
                            { offset: 0x413, bit: 6, label: "095 Spectral Sword", disabled: true },
                            { offset: 0x413, bit: 7, label: "096 Automaton ZX27", separator: true, disabled: true },
                            { offset: 0x414, bit: 0, label: "097 Medusa Head", disabled: true },
                            { offset: 0x414, bit: 1, label: "098 Gorgon Head" },
                            { offset: 0x414, bit: 2, label: "099 Mad Snatcher", disabled: true },
                            { offset: 0x414, bit: 3, label: "100 Great Knight" },
                            { offset: 0x414, bit: 4, label: "101 King Skeleton" },
                            { offset: 0x414, bit: 5, label: "102 Winged Skeleton", disabled: true },
                            { offset: 0x414, bit: 6, label: "103 Final Knight" },
                            { offset: 0x414, bit: 7, label: "104 Jiang Shi", separator: true, disabled: true },
                            { offset: 0x415, bit: 0, label: "105 Demon Lord", disabled: true },
                            { offset: 0x415, bit: 1, label: "106 Double Hammer", disabled: true },
                            { offset: 0x415, bit: 2, label: "107 Weapon Master", disabled: true },
                            { offset: 0x415, bit: 3, label: "108 Giant Skeleton", disabled: true },
                            { offset: 0x415, bit: 4, label: "109 Arthroverta", disabled: true },
                            { offset: 0x415, bit: 5, label: "110 Brachyura", disabled: true },
                            { offset: 0x415, bit: 6, label: "111 Maneater", disabled: true },
                            { offset: 0x415, bit: 7, label: "112 Rusalka", separator: true, disabled: true },
                            { offset: 0x416, bit: 0, label: "113 Goliath", disabled: true },
                            { offset: 0x416, bit: 1, label: "114 Gravedorcus", disabled: true },
                            { offset: 0x416, bit: 2, label: "115 Albus", disabled: true },
                            { offset: 0x416, bit: 3, label: "116 Barlowe", disabled: true },
                            { offset: 0x416, bit: 4, label: "117 Wallman", disabled: true },
                            { offset: 0x416, bit: 5, label: "118 Blackmore", disabled: true },
                            { offset: 0x416, bit: 6, label: "119 Eligor", disabled: true },
                            { offset: 0x416, bit: 7, label: "120 Death", separator: true, disabled: true },
                            { offset: 0x417, bit: 0, label: "121 Dracula", disabled: true },
                          ],
                        },
                      ],
                    },
