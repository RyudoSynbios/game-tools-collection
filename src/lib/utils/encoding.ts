...
const shiftJis: { [key: string]: string } = {
  0x0: "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\u001b\u001c\u001d\u001e\u001f !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\u007F",
  0x86: "をぁぃぅぇぉゃゅょっーあいうえおかきくけこさしすせそ 。「」、・ヲァィゥェォャュョッーアイウエオカキクケコサシスセソタチツテトナニヌネノハヒフヘホマミムメモヤユヨラリルレロワン゛゜たちつてとなにぬねのはひふへほまみむめもやゆよらりるれろわん",
  0xde93: "ゔ",
  0xde96: "がぎぐげござじずぜぞ",
  0xdea6: "ヺ",
  0xdeb3: "ヴ",
  0xdeb6: "ガギグゲゴザジズゼゾダヂヅデド",
  0xdeca: "バビブベボ",
  0xdedc: "ヷ",
  0xdee0: "だぢづでど",
  0xdeea: "ばびぶべぼ",
